...
export default class UserEdit extends Component {
    ...
    componentDidMount() {
        ...
        axios.get('https://pathpradarshak.netlify.app/user?id='+this.props.match.params.id)
            .then(response => {
            ...
            axios.get('https://pathpradarshak.netlify.app/showroles/')
            .then(response => {
    ...
    delete(id){
      console.log(id);
      axios.delete('https://pathpradarshak.netlify.app/user?id='+this.props.match.params.id)
        .then((result) => {
    ...
    onSubmit = (e) => {
        ...
        axios.put('https://pathpradarshak.netlify.app/user?id='+this.props.match.params.id, {first_name, last_name, email, password, role})
        .then((result) => {
          this.props.history.push("/allusers/")
        });
    }
