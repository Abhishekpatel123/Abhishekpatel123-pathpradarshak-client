...
export default class CreateEnroll extends Component {
  ...
  componentDidMount() {
    axios
      .get("https://pathpradarshak.netlify.app/courses/")
      .then(response => {
    ...
    axios
      .get("https://pathpradarshak.netlify.app/users/")
      .then(response => {
  ...
  onSubmit(e) {
    ...
    axios.post("https://pathpradarshak.netlify.app/enroll/add/", newTodo).then(result => {
