...
const ShowCat = (props) => (
  <option key={props.todo.categoryName} value={props.todo.categoryName}>
...
export default class EditCourse extends Component {
  ...
  onSubmit = (e) => {
    ...
    const { courseName, courseDescription, category, instructor } =
      this.state.todos;
              ...
              <form onSubmit={this.onSubmit}>
                <div class='form-group'>
                  ...
                  <input
                    ...
                    class='form-control'
                    name='courseName'
                    value={this.state.todos.courseName}
                ...
                <div class='form-group'>
                  ...
                  <textarea
                    ...
                    value={this.state.todos.courseDescription}
                    onChange={this.onChange}
